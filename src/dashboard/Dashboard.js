      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <section className="col-lg-7 connectedSortable">
            ...
            {/* TO DO List */}
            <div className="card"  style={{width:'100%',fontSize:12,fontWeight:'bold'}}>
              <div className="card-header">
                <h1 className="card-title"  style={{fontSize:15,fontWeight:'bold'}}>
      ...
      <tbody style={{fontSize:14}}>
        ...
        <tr>
          ...
          <section className="col-lg-5 ">
              <div  className="card bg-gradient-primary" style={{width:'100%',fontSize:16}}>
              <div className="card-header">
                <h3 className="card-title" style={{fontSize:15,fontWeight:'bold'}}>
                  <i className="ion ion-clipboard mr-1" />

...
function AdminProfile() {
            ...
            <div className="card"  style={{width:'100%'}}>
              <div className="card-header">
                <h1 className="card-title">
                  ...
                  <span style={{color:Colors.primary, fontWeight:'bold',fontSize:25}}>Edit Profile</span>
                </h1>
              </div>
  ...
  {({ touched, errors,handleSubmit, handleBlur, values,handleChange }) =>( 
         ...
         <div style={{display:'flex', justifyContent:'center',alignItems:'center', flexDirection:'column'}} >
          ...
          {touched.newPass && errors.newPass ? <div className='error' style={{  fontSize: 15, color: 'red', marginBottom:"2%"}}> {errors.newPass}</div> : null}
          ...
          <div style={{ display:"flex", justifyContent:"center", alignItems:"center" , marginTop:"1%"}}>
                 <Button type="submit" id="sub_butt" style={{borderColor:Colors.white, borderRadius:20, backgroundColor:Colors.primary, borderWidth:4, width:'30%' ,}}>
                 Update</Button>
          </div>  
           </form>
           )}

...
export default function Temp() {
  return (
    ...
    <a href="#/" className="logo"><span>e</span>vento</a>
...
<section className="footer">
    ...
    <div className="box-container">
        ...
        <div className="box">
            ...
            <a href="#"> <i className="fas fa-map-marker-alt"></i> jogeshwari </a>
            <a href="#"> <i className="fas fa-map-marker-alt"></i> goregaon </a>
            <a href="#"> <i className="fas fa-map-marker-alt"></i> navi mumbai </a>
            <a href="#"> <i className="fas fa-map-marker-alt"></i> andheri </a>
        </div>
        ...
        <div className="box">
            ...
            <a href="#"> <i className="fas fa-envelope"></i> anasshaikh@gmail.com </a>
